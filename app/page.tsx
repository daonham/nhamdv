...
const structuredData = {
  ...
  description:
    'Experienced Full Stack Developer with 8+ years in web and mobile development, specializing in React, Next.js, Node.js, and modern JavaScript technologies.',
  url: 'https://nhamdv.dev',
  image: 'https://nhamdv.dev/avatar.png',
  ...
  sameAs: [
    'https://www.linkedin.com/in/nh%C3%A2m-%C4%91%C3%A0o-03a561136/',
    'https://x.com/Nhamkin',
    'https://www.facebook.com/daovan.nham',
    'https://github.com/nhamdv'
  ],
  knowsAbout: [
    'JavaScript',
    'TypeScript',
  ...
  worksFor: {
    '@type': 'Organization',
    name: 'ThimPress',
    description: 'Leading technical teams and managing outsourcing projects'
  }
};
  ...
  return (
    <>
      ...
      <main className="relative flex min-h-[100dvh] w-full flex-col items-center overflow-hidden">
        ...
        <section
          id="about"
          className="mx-auto mt-16 w-full max-w-screen-md px-4"
          aria-labelledby="about-heading"
        >
          <div className="flex flex-col gap-4">
            <h2 id="about-heading" className="text-lg font-medium">
              About me
            </h2>
            <div className="flex flex-col gap-2">
              <article className="prose prose-sm max-w-none dark:text-gray-300">
                <p>
                  ...
                  specializing in both frontend and backend technologies. Throughout my career, I
                  have contributed to a wide range of projects, from startups to enterprise-level
                ...
                <p>
                  ...
                  Express.js, and Node.js on the backend. Additionally, I have experience working
                  with React Native to develop cross-platform mobile applications. I always strive
                  to apply best practices and optimal software architectures to ensure a clean,
        ...
        >
          <div className="flex flex-col gap-4">
            <h2 id="skills-heading" className="text-lg font-medium">
              Skills
            </h2>
            <div className="flex flex-col gap-2">
              <ul className="flex flex-col gap-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li className="flex gap-2.5">
                  <span className="mt-2 size-1.25 rounded-full bg-gray-600" />
                  <span className="flex-1">
                    <span className="font-medium">Components:</span> Shadcn/ui, Radix UI,
                    HeadlessUI, MUI, Antd, Mantine.
                  </span>
                </li>
                <li className="flex gap-2.5">
                  <span className="mt-2 size-1.25 rounded-full bg-gray-600" />
        ...
        >
          <div className="flex flex-col gap-4">
            <h2 id="experience-heading" className="text-lg font-medium">
              Experience
            </h2>
            <Experience />
          </div>
        ...
        >
          <div className="flex flex-col gap-4">
            <h2 id="education-heading" className="text-lg font-medium">
              Education
            </h2>
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2">
